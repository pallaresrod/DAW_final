                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Litoria Produccións</h1>
                                    </div>
                                    <form class="user" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                   id="login" name="login" placeholder="Introduzca su nombre de usuario"
                                                   value="<?php echo isset($inputLogin) ? $inputLogin : ''; ?>">
                                        </div>
