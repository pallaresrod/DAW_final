                        ...
                        <tbody>
                            ...
                            foreach ($categorias as $c) {
                                ...
                                <tr>
                                    ...
                                    <td>                              
                                        <a class="btn btn-success ml-1" href="/familia/view/<?php echo $c['idCategoria']; ?>"><i class="fas fa-eye text-white"></i></a>
                                        <?php
                                        if (strpos($_SESSION['permisos'], 'w') !== false) {
                                            ?>
                                            <a class="btn btn-dark ml-1" href="/familia/edit/<?php echo $c['idCategoria']; ?>"><i class="fas fa-edit text-white"></i></a>
                                            <a class="btn btn-danger ml-1" href="/familia/delete/<?php echo $c['idCategoria']; ?>"><i class="fas fa-trash text-white"></i></a>
                                            <?php
                                        }
                                        ?>
                                    </td>
