...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Filtrar</h6>
        </div>
        <div class="card-body">
                        ...
                        <tbody>
                            ...
                            foreach ($categorias as $c) {
                                ...
                                <tr>
                                    ...
                                    <td>                              
                                        <a class="btn btn-success ml-1" href="/categoria/view/<?php echo $c['idCategoria']; ?>"><i class="fas fa-eye text-white"></i></a>
                                        <?php
                                        if (strpos($_SESSION['permisos'], 'w') !== false) {
                                            ?>
                                            <a class="btn btn-dark ml-1" href="/categoria/edit/<?php echo $c['idCategoria']; ?>"><i class="fas fa-edit text-white"></i></a>
                                            <a class="btn btn-danger ml-1" href="/categoria/delete/<?php echo $c['idCategoria']; ?>"><i class="fas fa-trash text-white"></i></a>
                                            <?php
                                        }
                                        ?>
                                    </td>
